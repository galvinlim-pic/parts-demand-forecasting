...
spark.sql(f"DROP TABLE IF EXISTS {catalog}.{dbname}.material_shortage")
material_shortage_df.write.mode("overwrite").saveAsTable(f"{catalog}.{dbname}.material_shortage")
